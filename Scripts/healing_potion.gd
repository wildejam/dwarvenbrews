...
@onready var player = $".."
@onready var projectile_mesh = $healing_potion_mesh
@onready var projectile_collision = $healing_potion_collision
@onready var aoe = $healing_potion_aoe
@onready var aoe_visual = $healing_potion_aoe/healing_potion_aoe_visual
...
func _on_body_shape_entered(_body_rid, body, _body_shape_index, _local_shape_index):
	...
	$healing_sound.pitch_scale = randf_range(0.9, 1.1)
	$glass_shatter.play()
	$healing_sound.play()
